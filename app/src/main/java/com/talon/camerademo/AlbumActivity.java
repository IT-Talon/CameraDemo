 ...
 */
public class AlbumActivity extends Activity implements AlbumAdapter.OnPhotoClickListener {
    ...
    @OnClick({R.id.btnBack, R.id.floatView, R.id.dirView})
    ...
    @OnCheckedChanged({R.id.btnCategory})
